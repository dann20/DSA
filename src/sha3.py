...
class Keccak:
    ...
    def update(self, arg):
        ...
        # self.buffered_data += codecs.encode(arg.encode('ascii'), 'hex').decode('ascii')
        self.buffered_data += codecs.encode(arg, 'hex').decode('ascii')
    ...
    def digest(self):
        ...
        M = _build_message_pair(codecs.decode(self.buffered_data, 'hex'))
        ...
        self.last_digest = codecs.decode(Z[:2 * self.n // 8], 'hex')
        return self.last_digest
    ...
    def hexdigest(self):
        ...
        return codecs.encode(self.digest(), 'hex').decode('ascii')
